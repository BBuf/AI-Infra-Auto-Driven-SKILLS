...
已按 SGLang `origin/main` 的 `50f405816` 复核 DeepSeek-V4 相关代码。除下方 2026-05-01 生成的历史卡片外，当前优化判断还需要纳入 `#24816` SM90 CUTLASS W4A16/MXFP4 MoE、`#24890` KV Compression V2、`#24897` fused SiLU+clamp+FP8 quant、`#24925` TokenSpeed MLA、`#24986` Hopper W4(MXFP4)A16、`#25001` MLA LoRA q_b/kv_b、`#25052` W4A4 MegaMoE，以及 `#25243` H100 cookbook 更新。
