...
已按 vLLM `origin/main` 的 `f3d536059` 复核 DeepSeek-V3.2 相关代码。当前历史需要补充 `#42062`：`vllm/v1/attention/ops/rocm_aiter_mla_sparse.py` 在 `gfx950`/MI355X sparse MLA 上启用 ROCm AITER/Gluon paged-MQA logits。
