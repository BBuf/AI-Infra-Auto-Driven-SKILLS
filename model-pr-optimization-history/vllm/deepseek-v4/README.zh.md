...
已按 vLLM `origin/main` 的 `f3d536059` 复核 DeepSeek-V4 相关代码。下方历史中原先作为开放优化项的 `#41255` tile/head-compute、`#41263` norm/router fusion、`#41428` fused Indexer-Q quant 已进入 main；还应补充 `#40392` MLA RoPE/KV-cache fusion、`#40871` AMD DeepSeek-V4 support、`#41443` pre-attn GEMM knob、`#41522` MegaMoE pure-TP guard、`#41536` fused `mhc_post_pre`、`#41694` PP support、`#41778` TokenSpeed MLA、`#41801` parser bool/wrapper handling、`#41812` ROCm DSV4 sparse-MLA Triton kernels、`#41946` AITER MHC support、`#41957` DSV4 disaggregated serving fix、`#42112` ragged MLA prefill workspace warmup、`#42169` top-k numerical fix、`#42236` dequant gather K cache improvement、`#42320` MTP hidden-state 修复、`#42342` Cutlass/CuTe dependency 修复。`#41441` all-reduce + `mhc_post` 仍只作为 watch item。
