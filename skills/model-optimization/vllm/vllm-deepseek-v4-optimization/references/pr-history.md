...
| --- | --- | --- | --- |
| [#40392](https://github.com/vllm-project/vllm/pull/40392) | merged | `vllm/compilation/passes/fusion/mla_rope_kvcache_cat_fusion.py`, `csrc/cache_kernels_fused.cu`, `vllm/model_executor/layers/attention/mla_attention.py` | MLA RoPE + KV-cache cat fusion is a current compile-pass precedent. |
| [#40871](https://github.com/vllm-project/vllm/pull/40871) | merged | `vllm/model_executor/layers/deepseek_v4_attention.py`, `vllm/model_executor/models/deepseek_v4.py`, `vllm/v1/attention/ops/rocm_aiter_mla_sparse.py` | AMD DeepSeek-V4 support landed after the generated history and changes the ROCm runtime surface. |
...
| [#41443](https://github.com/vllm-project/vllm/pull/41443) | merged | `vllm/envs.py`, `vllm/model_executor/layers/deepseek_v4_attention.py`, `vllm/utils/multi_stream_utils.py` | Pre-attn GEMM has an explicit enablement knob in current mainline. |
| [#41522](https://github.com/vllm-project/vllm/pull/41522) | merged | `vllm/model_executor/models/deepseek_v4.py` | MegaMoE flag handling is guarded for pure TP and should not be assumed globally enabled. |
| [#41536](https://github.com/vllm-project/vllm/pull/41536) | merged | `vllm/model_executor/layers/mhc.py`, `vllm/model_executor/models/deepseek_v4.py`, `tests/kernels/test_mhc_kernels.py` | Fused `mhc_post_pre` is part of the current MHC kernel family. |
| [#41694](https://github.com/vllm-project/vllm/pull/41694) | merged | `vllm/model_executor/models/deepseek_v4.py`, `docs/models/supported_models.md` | Pipeline parallel support for DeepSeek-V4 is now explicit. |
...
| [#41801](https://github.com/vllm-project/vllm/pull/41801) | merged | `vllm/tool_parsers/deepseekv32_tool_parser.py`, `tests/tool_parsers/test_deepseekv4_tool_parser.py` | DSV3.2/DSV4 parser handling now respects string `true`/`false` attributes and wrapped arguments. |
| [#41812](https://github.com/vllm-project/vllm/pull/41812) | merged | `vllm/v1/attention/backends/mla/rocm_aiter_mla_sparse_dsv4.py`, `vllm/v1/attention/backends/mla/flashmla_sparse.py`, `vllm/v1/attention/ops/rocm_aiter_mla_sparse.py` | ROCm DSV4 sparse-MLA Triton kernels are current mainline evidence. |
| [#41946](https://github.com/vllm-project/vllm/pull/41946) | merged | `vllm/model_executor/kernels/mhc/aiter.py`, `vllm/model_executor/layers/mhc.py`, `vllm/model_executor/models/deepseek_v4.py` | AITER MHC support is now part of ROCm DeepSeek-V4 perf triage. |
| [#41957](https://github.com/vllm-project/vllm/pull/41957) | merged | `vllm/distributed/kv_transfer/kv_connector/v1/nixl/tp_mapping.py`, `vllm/distributed/kv_transfer/kv_connector/v1/nixl/worker.py` | DSV4 disaggregated serving has a post-history TP mapping fix. |
| [#42112](https://github.com/vllm-project/vllm/pull/42112) | merged | `vllm/v1/attention/backends/mla/prefill/trtllm_ragged.py`, `vllm/v1/attention/backends/mla/prefill/flashinfer.py` | Ragged MLA prefill workspace warmup is current workspace-management evidence. |
| [#42169](https://github.com/vllm-project/vllm/pull/42169) | merged | `csrc/topk.cu` | DeepSeek-V4 top-k numerical behavior was fixed for unaligned max-model-len. |
| [#42236](https://github.com/vllm-project/vllm/pull/42236) | merged | `vllm/v1/attention/ops/deepseek_v4_ops/dequant_gather_k_cutedsl.py`, `vllm/v1/attention/ops/deepseek_v4_ops/cache_utils.py` | Dequant gather K cache has a newer CuTe DSL kernel path. |
