...
| --- | --- | --- |
| [#24125](https://github.com/sgl-project/sglang/pull/24125) | skip redundant TileLang decode cat/copy | Check when GLM-5 decode traces show `CatArrayBatchedCopy` or copy bursts. |
| [#23965](https://github.com/sgl-project/sglang/pull/23965) | PDL for selected DSV32 / GLM5 kernels | Changes launch-overlap interpretation around dependent decode kernels. |
