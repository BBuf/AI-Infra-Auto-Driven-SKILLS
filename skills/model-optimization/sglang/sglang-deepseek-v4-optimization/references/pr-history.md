...
| --- | --- | --- | --- |
| [#24367](https://github.com/sgl-project/sglang/pull/24367) | merged | `docs_new/src/snippets/autoregressive/deepseek-v4-deployment.jsx` | B300 Pro recipes were refreshed with accuracy-verified serving configs after the original history generation. |
| [#24775](https://github.com/sgl-project/sglang/pull/24775) | merged | `python/sglang/srt/layers/mhc.py`, `python/sglang/srt/layers/mhc_head.py`, `python/sglang/srt/models/deepseek_v4.py` | Current MHC pipeline work covers DeepGEMM, fused norm, and fused head-compute paths. |
| [#24793](https://github.com/sgl-project/sglang/pull/24793) | merged | `python/sglang/srt/server_args.py`, `python/sglang/srt/model_loader/*`, `docs_new/src/snippets/autoregressive/deepseek-v4-deployment.jsx`, `test/registered/dsv4/*` | Cherry-picked missing DSV4 branch fixes and test/dependency wiring; check this before reintroducing loader/server-arg assumptions. |
| [#24816](https://github.com/sgl-project/sglang/pull/24816) | merged | `python/sglang/srt/layers/quantization/mxfp4_flashinfer_cutlass_moe.py`, `python/sglang/test/bench_mxfp4_sm90_kernels.py`, `test/registered/unit/layers/quantization/test_mxfp4_sm90_cutlass.py` | Treat FlashInfer SM90 CUTLASS W4A16/MXFP4 MoE as a current DeepSeek-V4 kernel option. |
...
| [#24949](https://github.com/sgl-project/sglang/pull/24949) | merged | `python/sglang/srt/models/deepseek_v2.py`, `python/sglang/srt/model_executor/model_runner.py`, `python/sglang/srt/environ.py` | DeepSeek-V4-Pro shared expert TP=1 handling is now part of the runtime contract. |
| [#24986](https://github.com/sgl-project/sglang/pull/24986) | merged | `python/sglang/srt/layers/quantization/mxfp4.py`, `python/sglang/srt/layers/quantization/mxfp4_marlin_moe.py`, `test/registered/dsv4/test_deepseek_v4_flash_fp4_h200.py`, `test/registered/dsv4/test_deepseek_v4_flash_fp8_h200.py` | Hopper W4(MXFP4)A16 now has a checked SGLang path. |
...
| [#25052](https://github.com/sgl-project/sglang/pull/25052) | merged | `python/sglang/srt/layers/moe/mega_moe.py`, `python/sglang/srt/environ.py`, `test/registered/dsv4/test_deepseek_v4_flash_fp4_megamoe_b200.py` | W4A4 MegaMoE should be checked before changing DeepSeek-V4 MoE routing or quantization. |
| [#25152](https://github.com/sgl-project/sglang/pull/25152) | merged | `docs_new/src/snippets/autoregressive/deepseek-v4-deployment.jsx` | H200 FP8 Flash max-throughput recipes prepend `SGLANG_JIT_DEEPGEMM_PRECOMPILE=0`. |
