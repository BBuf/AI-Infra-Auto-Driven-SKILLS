...
| --- | --- | --- |
| [#18612](https://github.com/sgl-project/sglang/pull/18612) | NVFP4 CUTLASS MoE fused SiLU+Mul into expert quant | Concrete activation-plus-quant MoE fusion precedent. |
| [#22918](https://github.com/sgl-project/sglang/pull/22918) | FlashInfer per-token NVFP4 MoE | May replace standalone per-token quant/dequant support kernels. |
